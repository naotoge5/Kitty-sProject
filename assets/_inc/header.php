            ...
            <div class="pos-f-t">
                <?php if (preg_match('/public/', $sever_url)) : ?>
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarContent">
                        <ul class="list-group list-group-flush">
                            <a href="top.php" class="list-group-item list-group-item-action">検索ページ</a>
                            <button class="list-group-item list-group-item-action" data-toggle="collapse" data-target="#favoriteContent" aria-controls="favoriteContent" aria-expanded="false">お気に入り
                            </button>
                ...
                <?php else : ?>
                    ...
                    <nav class="navbar navbar-dark bg-dark py-3">
                        ...
                        <a class="navbar-brand" href="management.php">管理画面</a>
                    </nav>
                    <div class="collapse" id="navbarContent">
                        ...
                        <a href="javascript:logout.submit()" class="list-group-item list-group-flush list-group-item-action">ログアウト</a>
                    </div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
